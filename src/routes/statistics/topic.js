...
import powerSchedulerResourceGroups from '@controllers/statistics/topic/power-schedule-resource-groups';
...
const controllers = [
    ...
    { url: '/power-scheduler-resource-groups', func: powerSchedulerResourceGroups },
